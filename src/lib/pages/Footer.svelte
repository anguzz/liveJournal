...
<Footer id="Footer" >
  ...
  <footer id="theme" class='bottom-0 left-0 flex flex-col w-full gap-4 px-14 py-10 md:gap-4'>
    <div class='w-full h-px m-auto bg-gradient-to-r from-slate via-slate-400 to-transparent'></div>
    ...
    <div class='w-full h-px m-auto bg-gradient-to-r from-transparent via-slate-700 to-transparent'></div>
